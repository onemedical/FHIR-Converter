    ...
    it('should return 403 WriteError when posting new file with incorrect path', function (done) {
        supertest(app)
            ...
            .expect(function (response) {
                ...
                if (e.error.code != "WriteError" || !e.error.message.startsWith('Unable to write template')) {
...
describe('Helper "evaluate" usage', function () {
    ...
    const templateBase64Str = 'eyB7eyN3aXRoIChldmFsdWF0ZSAiaGVscGVyc1Rlc3RQYXJ0aWFsLmhicyIgeDE9IjEiIHgyPSIyIil9fSAib3V0Ijoie3tjfX0iIHt7L3dpdGh9fSB9';

    // Message : MSH|^~\&|AccMgr|1|||20050110045504||ADT^A01|599102|P|2.3|||
    const messageBase64Str = 'TVNIfF5+XCZ8QWNjTWdyfDF8fHwyMDA1MDExMDA0NTUwNHx8QURUXkEwMXw1OTkxMDJ8UHwyLjN8fHw=';
